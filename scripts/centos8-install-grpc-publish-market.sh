...
SERVICE_NAME=${SERVICE_NAME:-"publish-market"}
SERVICE_DESCRIPTION=${SERVICE_DESCRIPTION:-}


SERVICE_HOME="$HOME/productions/publish/${SERVICE_NAME}"
...
if [[ $is_overwrite == "Y" || $is_overwrite == "y" ]]; then
  ...
  export SERVICE_SERVER_OPTS="publish --cmd.event_publish.runs=market";\
  export SERVICE_WORKING_FOLDER=$SERVICE_HOME;
